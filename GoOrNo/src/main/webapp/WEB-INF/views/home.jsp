...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/logo.png" alt="">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/profile-img.jpg" alt="Profile" class="rounded-circle">
              ...
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/product-1.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/product-2.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/product-3.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/product-4.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/product-5.jpg" alt=""></a></th>
            ...
            <div class="card-body pb-0">
              ...
              <div class="news">
                <div class="post-item clearfix">
                  <img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/news-1.jpg" alt="">
                  <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                  <p>Sit recusandae non aspernatur laboriosam. Quia enim eligendi sed ut harum...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/news-2.jpg" alt="">
                  <h4><a href="#">Quidem autem et impedit</a></h4>
                  <p>Illo nemo neque maiores vitae officiis cum eum turos elan dries werona nande...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/news-3.jpg" alt="">
                  <h4><a href="#">Id quia et et ut maxime similique occaecati ut</a></h4>
                  <p>Fugiat voluptas vero eaque accusantium eos. Consequuntur sed ipsam et totam...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/news-4.jpg" alt="">
                  <h4><a href="#">Laborum corporis quo dara net para</a></h4>
                  <p>Qui enim quia optio. Eligendi aut asperiores enim repellendusvel rerum cuder...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<%=request.getContextPath()%>/resources/assetsAdmin/img/news-5.jpg" alt="">
  ...
  <!-- Vendor JS Files -->
  <script src="<%=request.getContextPath()%>/resources/assetsAdmin/vendor/apexcharts/apexcharts.min.js"></script>
  ...
  <script src="<%=request.getContextPath() %>/assetsAdmin/js/main.js"></script>
