						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<!-- 입력폼 시작 -->
									<form:form commandName="qna" action="reply.qna" method="post">
										<input type="hidden" id="isAdmin" value="yes">
										<input type="hidden" id="isSuccess" value="${ isSuccess }">
										<input type="hidden" name="orgNo" value="${ param.orgNo }">
										<table class="table table-borderless" width="100%">
											<tr>
												<td>
													<font size="4px"><b> 제목 </b></font>
													<input type="text" name="subject" value="[답변] ${ org.subject }" class="form-control" style="width:80%; diaply:inline;" disabled="disabled">
													<input type="hidden" name="subject" value="[답변] ${ org.subject }">
												</td>
											</tr>
											<tr>
												<td>
											...
											<tr>
												<td align="center">
													<input type="submit" value="글작성" class="btn btn-light">
												</td>
											</tr>
										</table>
									</form:form>
