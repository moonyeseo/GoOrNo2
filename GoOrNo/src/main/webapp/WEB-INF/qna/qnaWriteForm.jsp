										...
										<table class="table table-borderless" width="100%">
											<tr>
												<td>
													...
													<input type="text" name="subject" value="${ qna.subject }" class="form-control" style="width:80%; diaply:inline;" maxlength="30" required>
											...
											<tr>
												<td align="center">
													...
													<input type="button" onClick="location.href='list.qna?pageNumber=${param.pageNumber}&whatColumn=${ param.whatColumn }&keyword=${ param.keyword }'" value="글목록" class="btn btn-light">
												</td>
											</tr>
										</table>
									</form:form>
