...
<head>
  ...
  <title>GoOrNo_Admin</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
<%--   <link href="<%=request.getContextPath() %>/resources/image/GoOrNo_logo.png" rel="icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="#" class="logo d-flex align-items-center">
        <img src="<%=request.getContextPath() %>/resources/image/GoOrNo_logo.png" alt="">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">  
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="list.users">
          <i class="bi bi-person"></i>
          <span>User</span>
        </a>
      </li>
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="list.board?isAdmin=yes">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="list.report">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="list.notice?isAdmin=yes">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="list.faq?isAdmin=yes">
         <i class="bi bi-question-circle"></i>
          <span>F.A.Q</span>
        </a>
      </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="list.qna?isAdmin=yes">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<%=request.getContextPath()%>/main.jsp">
