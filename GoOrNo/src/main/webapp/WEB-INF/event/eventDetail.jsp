            ...
            <table>
                ...
                <tr>
                	<td colspan="2">
	  					...
	  					<input type="button" class="btn btn-outline-primary btn-sm" value="목록보기" onClick="location.href='list.event?eventNo=${event.event_no }&whatColumn=${param.whatColumn}&keyword=${param.keyword}&pageNumber=${param.pageNumber}'">
