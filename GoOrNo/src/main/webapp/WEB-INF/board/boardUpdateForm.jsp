						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<!-- 입력폼 시작 -->
									<form:form commandName="board" action="update.board" method="post">
										...
										<table class="table table-borderless" width="100%">
											...
											<tr>
												<td>
													<textarea rows="10" style="resize:none;" name="content" class="form-control" maxlength="300" required>${ board.content }</textarea>
											...
											<tr>
												<td align="center">
													...
													<input type="button" onClick="location.href='list.board?pageNumber=${param.pageNumber}&whatColumn=${ param.whatColumn }&keyword=${ param.keyword }'" value="목록보기" class="btn btn-light">
												</td>
											</tr>
										</table>
									</form:form>
