						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<!-- 입력폼 시작 -->
									<form:form commandName="faq" action="update.faq" method="post">
										...
										<table class="table table-borderless" width="100%">
											...
											<tr>
												<td>
													<textarea rows="10" style="resize:none;" name="answer" class="form-control" maxlength="300" required>${ faq.answer }</textarea>
